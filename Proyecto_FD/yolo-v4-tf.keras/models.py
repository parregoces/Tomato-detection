...
class Yolov4(object):
    def __init__(self,
                 weight_path=None,
                 class_name_path='/content/drive/MyDrive/Proyecto_FD/Clases.txt',
                 config=yolo_config,
                 ):
    ...
    def export_prediction(self, annotation_path, pred_folder_path, img_folder_path, bs=2):
        with open(annotation_path) as file:
            ...
            for batch_idx in tqdm(range(0, len(img_paths), bs)):
                print("Total de imágenes:", len(img_paths))
                print("Batch:", batch_idx, "Índices:", batch_idx * bs, (batch_idx + 1) * bs)
                ...
                print(b_boxes, b_scores, b_classes, b_valid_detections)
                for k in range(len(paths)):
                    ...
                    print("Escribiendo en el archivo:", output_path)
        ...
        with open(output_files_path + "/output.txt", 'w') as output_file:
            ...
            for class_index, class_name in enumerate(gt_classes):
                ...
                if True:
                    ...
                    plt.gcf().suptitle('AP ' + class_name)
